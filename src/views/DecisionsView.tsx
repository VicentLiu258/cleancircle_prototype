import { decisions, pendingQuestions } from '../data/decisions';
...
export function DecisionsView({ onNavigate }: Props) {
  return (
    <div className="mx-auto max-w-5xl px-6 py-8">
      ...
      <h2 className="mt-12 text-2xl font-bold text-gray-800">待业务确认清单（B-Q01 … B-Q10）</h2>
      <p className="mt-1 text-sm text-gray-500">来自《管理后台 MVP 需求文档》§10，附原型当前占位方案。</p>
