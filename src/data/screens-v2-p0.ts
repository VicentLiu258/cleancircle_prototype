    ...
    states: [
      {
        ...
        blocks: [
          side('课程组合'),
          { kind: 'topbar', label: '内容中心 / AI 课程组合', sub: '角色：课程运营 / 审核人' },
          { kind: 'page-header', label: 'AI 课程方案池', sub: 'AI 根据目标、人群、周期和内容标签生成课程；所有方案必须人工审核后才能发布' },
          { kind: 'stat-row', items: ['待生成 2', 'AI 生成中 1', '待人工审核 6', '已退回 2', '已发布 18'] },
          { kind: 'filter-bar', label: '状态：全部 ｜ 目标：全部 ｜ 人群：全部 ｜ 生成时间：近30天' },
          {
            kind: 'table',
            cols: ['方案', '生成依据', '内容数', '风险校验', '状态', '操作'],
            items: [
              '黄体期舒缓·7天 ｜ 周期=黄体期；目标=舒缓 ｜ 7 ｜ 通过 ｜ 待审核 ｜ 审核',
              '新手塑形·21天 ｜ 新手；低冲击；20min ｜ 21 ｜ 1项提醒 ｜ 待审核 ｜ 审核',
              '肩颈恢复·5天 ｜ 久坐；肩颈不适 ｜ 5 ｜ 通过 ｜ 已退回 ｜ 查看原因',
              'START HERE ｜ 新用户；基础动作 ｜ 5 ｜ 通过 ｜ 已发布 ｜ 查看版本',
            ],
            to: 'B31',
            marker: 1,
          },
          { kind: 'button-primary', label: '✦ AI 生成课程方案' },
          { kind: 'button-secondary', label: '+ 人工新建（兜底）' },
        ],
      },
      {
        id: 'generate',
        ...
        blocks: [
          side('课程组合'),
          { kind: 'topbar', label: '内容中心 / AI 课程组合 / 新建任务', sub: '角色：课程运营' },
          { kind: 'page-header', label: '配置 AI 生成任务', sub: '运营人员给出业务约束，AI 负责组合内容；生成结果不会直接上线' },
          { kind: 'steps', items: ['配置目标', 'AI 生成', '人工审核', '发布'], activeStep: 0, marker: 1 },
          { kind: 'form-row', label: '课程目标', sub: '●塑形 ○舒缓 ○体能 ○恢复 ○自定义' },
          { kind: 'form-row', label: '目标人群', sub: '新手；低冲击；无器械；可叠加周期/健康禁忌标签' },
          { kind: 'form-row', label: '结构约束', sub: '周期 21 天 ｜ 每天 20–30 分钟 ｜ 每周 1 个休息日 ｜ 热身/主训/拉伸完整' },
          { kind: 'form-row', label: '内容范围', sub: '仅选 AI 打标已复核且已发布的视频（B07）｜ 排除版权/安全风险内容' },
          { kind: 'form-row', label: '推荐偏好', sub: '内容多样性 ≥70% ｜ 同部位连续不超过 2 天 ｜ 难度渐进' },
          { kind: 'alert', tone: 'info', label: 'AI 将输出：课程结构、逐日内容、选用理由、风险提示和可替换内容', marker: 2 },
          { kind: 'button-primary', label: '开始 AI 生成' },
          { kind: 'button-secondary', label: '保存任务草稿' },
        ],
      },
      {
        id: 'review',
        ...
        blocks: [
          side('课程组合'),
          { kind: 'topbar', label: '内容中心 / AI 课程组合 / 人工审核', sub: '审核人：课程运营' },
          { kind: 'page-header', label: '审核方案 · 新手塑形 21 天', sub: 'AI 生成 v3 · 08-12 14:32 · 基于已复核视频 48 条' },
          { kind: 'steps', items: ['配置目标', 'AI 生成', '人工审核', '发布'], activeStep: 2, marker: 1 },
          {
            kind: 'split',
            label: 'AI 方案摘要',
            sub: '系统校验与审核重点',
            items: ['21 天 / 18 个训练日 / 3 个恢复日', '难度：入门 → 初级', '内容重复率 11%', '推荐理由：低冲击、无器械、循序渐进'],
            right: ['✓ 版权与上下架状态通过', '✓ 健康禁忌冲突检查通过', '✎ 第 8 天与第 9 天同部位连续', '✎ 第 15 天时长 34 分钟，超出约束'],
          },
          {
            kind: 'table',
            cols: ['天', 'AI 推荐内容', '时长', '强度', '理由/提醒', '审核'],
            items: [
              'D1 ｜ 全身激活 ｜ 18min ｜ 低 ｜ 新手评估 ｜ 通过',
              'D8 ｜ 上肢塑形 ｜ 24min ｜ 中 ｜ 与 D9 同部位 ｜ 待调整',
              'D9 ｜ 手臂力量 ｜ 22min ｜ 中 ｜ 建议替换为下肢 ｜ 待调整',
              'D15 ｜ 核心+拉伸 ｜ 34min ｜ 中 ｜ 超时 4min ｜ 待调整',
            ],
            marker: 2,
          },
          { kind: 'form-row', label: '审核意见', sub: '必填：说明通过、退回或手工调整的理由' },
          { kind: 'button-primary', label: '进入手工调整' },
          { kind: 'button-secondary', label: '审核通过并提交发布' },
          { kind: 'button-danger', label: '退回 AI 重新生成', sub: '保留本次方案、参数与退回原因' },
        ],
      },
      {
        id: 'manual',
        ...
        blocks: [
          side('课程组合'),
          { kind: 'topbar', label: '内容中心 / AI 课程组合 / 手工调整', sub: '角色：课程审核人' },
          { kind: 'page-header', label: '调整并发布 · 新手塑形 21 天', sub: 'AI 草案 v3 → 人工修订 v3.1；所有修改进入审计记录' },
          { kind: 'steps', items: ['配置目标', 'AI 生成', '人工审核', '发布'], activeStep: 3, marker: 1 },
          { kind: 'alert', tone: 'warn', label: '仍有 2 项待确认：同部位连续、单日时长超限', sub: '解决全部阻断项后才可发布' },
          {
            kind: 'table',
            cols: ['天', '课程内容', '调整动作', '调整原因', '校验'],
            items: [
              'D8 ｜ 上肢塑形 ｜ 保留 ｜ 难度衔接需要 ｜ 提醒',
              'D9 ｜ 下肢激活（替换） ｜ 替换视频 ｜ 避免同部位连续 ｜ 通过',
              'D15 ｜ 核心 20min + 拉伸 8min ｜ 缩短 ｜ 满足 30min 上限 ｜ 通过',
            ],
            marker: 2,
          },
          { kind: 'form-row', label: '课程权益', sub: '●会员 ○免费 ○能量值兑换 ○单独购买' },
          { kind: 'form-row', label: '人工审核结论', sub: '通过；已处理风险项；审核人和时间自动记录' },
          { kind: 'button-primary', label: '确认发布 v3.1' },
          { kind: 'button-secondary', label: '保存修订草稿' },
        ],
      },
    ],
    annotations: {
      goal: '由 AI 生成课程组合方案，运营人员审核、修订后发布，兼顾效率、安全与可追溯。',
      entry: '内容中心-AI 课程组合',
      exit: ['B03', 'B04', 'B10'],
      role: '课程运营（发起 AI 任务）；课程审核人（审核与发布）',
      data: ['AI 生成参数与方案版本 — 课程编排服务', '已复核视频与标签 — B03/B06/B07', '课程权益 — 商品/会员', '审核意见与人工修改 — 审计日志'],
      actions: {
        primary: '配置 AI 生成任务；人工审核后发布',
        secondary: ['退回 AI 重生成', '手工替换/排序内容', '查看生成理由和风险校验', '查看版本差异'],
      },
      statesDesc: ['AI 方案池', 'AI 配置', '人工审核', '手工调整/发布'],
      triggers: ['AI 生成完成 → 进入待人工审核', '存在安全/版权阻断项 → 禁止发布', '人工修改 → 生成新版本并记录差异', '审核通过 → 才可发布到移动端'],
      deps: ['B03 视频库', 'B06 标签库', 'B07 AI 打标复核', 'B27 审计日志', '移动端 S10/S17/S29'],
      patches: ['后端反馈3：AI 配置、人工审核'],
    },
  },
