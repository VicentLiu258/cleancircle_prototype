...
export const screensV2P0: ScreenDef[] = [
  // ——— 工作台 ———
  {
    ...
    states: [
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            label: '快捷入口',
            sub: '说明',
            items: ['转化漏斗 B48', '业务趋势 B49', '用户行为 B50', '退款队列 B24', '发货 B40'],
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: 'text', label: '用户数据', sub: '社区与商城关闭不影响用户活跃口径' },
          ...
          { kind: 'text', label: '交易数据', sub: '仅保留会员订阅；商城商品订单隐藏' },
    ...
    annotations: {
      ...
      exit: ['B48', 'B49', 'B50', 'B24', 'B35', 'B40', 'B42'],
