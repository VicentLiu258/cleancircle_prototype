...
export const screensSupportG: ScreenDef[] = [
  {
    id: 'B14', name: '阶段建议列表/编辑', reqCode: '§4 B14', priority: 'P0', flow: 'C',
    states: [
  ...
  },
  {
    ...
    states: [
      { id: 'list', label: '触发器列表', blocks: [
        ...
        { kind: 'table', cols: ['触发器', '事件', '条件', '延时/时段', '频控', '模板', '预估人数', '状态', '操作'], items: [
          '注册未填问卷 ｜ 注册成功 ｜ 未开始问卷 ｜ +1h ｜ 1次 ｜ 引导评测 ｜ ~80/日 ｜ 启用 ｜ 编辑',
          '完成问卷未训练 ｜ 完成问卷 ｜ 24h无开练 ｜ +1天 10:00 ｜ 1次 ｜ 开练提醒 ｜ ~120/日 ｜ 启用 ｜ 编辑',
          '连胜鼓励3/7 ｜ 完课 ｜ 连续打卡=3或7 ｜ 即时 ｜ 同类型每日≤1 ｜ Jo姐鼓励 ｜ ~420/日 ｜ 启用 ｜ 编辑',
          '断练召回 ｜ 未完课 ｜ 断更2天/连续7天未训练 ｜ +1天 09:00-21:00 ｜ 每周≤2 ｜ 断练召回 ｜ ~1,800/日 ｜ 启用 ｜ 编辑',
          '会员到期/续费失败 ｜ 订阅事件 ｜ 将到期或续费失败 ｜ 10:00 ｜ 共2条 ｜ 到期提醒 ｜ ~90/日 ｜ 启用 ｜ 编辑',
          '能量值将过期 ｜ 资产事件 ｜ 有效期≤7天 ｜ 11:00 ｜ 每周≤1 ｜ 能量提醒 ｜ ~40/日 ｜ 停用 ｜ 编辑',
          '挑战赛将结束 ｜ 活动事件 ｜ 结束前1天 ｜ 12:00 ｜ 1次 ｜ 挑战提醒 ｜ ~200/日 ｜ 启用 ｜ 编辑',
        ], to: 'B16', marker: 1 },
    ...
    annotations: {
      ...
      data: [
        '触发事件（后端§2.4）：注册未问卷/完成问卷未训练/连打卡3·7/断更/7天未训练/会员到期/续费失败/能量将过期/挑战赛将结束',
        '条件组合/延时/允许时段/频控/去重/实验分组预留',
        '预估人数 — 近 7 日事件回放试算（H-11 占位口径）',
      ],
      actions: {
        primary: '保存并启用（二次确认 + 审计）',
        secondary: ['保存草稿', '查看关联模板', '查看发送预估明细', '查看任务实例 B28'],
      ...
      deps: ['移动端 S09 消息接收 / B-13 频控决策', 'B15 消息模板', 'B27 审计日志', 'B28 触达任务与效果'],
      patches: ['H-11', '后端需求§2.4'],
    },
  },
  {
    id: 'B26', name: '管理员/角色权限', reqCode: '§4 B26', priority: 'P0', flow: 'K',
    states: [
      { id: 'roles', label: '角色列表', blocks: [
        ...
        { kind: 'table', cols: ['角色', '成员', '模块范围', '数据范围', '敏感操作限制', '操作'], items: [
          ...
          '客服 ｜ 6 ｜ 用户档案/订阅/迁移/工单 ｜ 全部 ｜ 手机号脱敏/能量值需审批 ｜ 编辑',
      ...
      { id: 'edit', label: '权限树编辑', blocks: [
        ...
        { kind: 'split', label: '角色信息与成员', sub: '权限树（模块 × 操作类型 · 已覆盖 v2 IA）', items: [
          '角色：客服 ｜ 成员 6 人',
          '数据范围：全部用户（手机号脱敏）',
          '说明：一线查询与工单/企微入口',
        ], right: [
          '☑ 工作台：仅查看 KPI',
          '☑ 用户 CRM：查看/导出（脱敏）｜ ☐ 标签管理',
          '☑ 消息触达：仅查看任务 ｜ ☐ 发送',
          '☑ 订阅财务：仅查看 ｜ ☐ 退款审核 ｜ ☐ 对账',
          '☑ 能量值调整：申请 ｜ ☐ 审批',
          '☑ 企微配置：查看',
          '☐ 内容中心/课程 ｜ ☐ 问卷排课 ｜ ☐ 社区 ｜ ☐ 商城',
          '☐ 基础配置（版本/开关/公告） ｜ ☐ 敏感健康数据',
        ], marker: 1 },
      ...
      { id: 'admins', label: '管理员账号', blocks: [
        sideRole,
        { kind: 'topbar', label: '系统管理 / 管理员', sub: '角色：超级管理员' },
        { kind: 'page-header', label: '管理员账号', sub: '对齐 web /system/admins · 邀请、停用、角色分配；停用即踢出会话' },
        { kind: 'stat-row', items: ['管理员 12', '启用中 11', '已停用 1', '超级管理员 2'] },
        { kind: 'filter-bar', label: '搜索姓名/邮箱 ｜ 角色：全部 ｜ 状态：全部', marker: 1 },
        { kind: 'table', cols: ['管理员', '账号', '角色', '状态', '最近登录', '操作'], items: [
          '王运营 ｜ ops@cc.com ｜ 内容运营 ｜ 启用 ｜ 08-10 21:02 ｜ 编辑',
          '李健康 ｜ health@cc.com ｜ 课程/健康运营 ｜ 启用 ｜ 08-10 18:40 ｜ 编辑',
          '赵财务 ｜ finance@cc.com ｜ 财务 ｜ 启用 ｜ 08-09 10:11 ｜ 编辑',
          '周客服 ｜ cs@cc.com ｜ 客服 ｜ 停用 ｜ 07-28 ｜ 启用',
        ], marker: 2 },
        { kind: 'button-primary', label: '+ 邀请管理员', marker: 3 },
        { kind: 'button-secondary', label: '角色权限配置', to: 'B26' },
        { kind: 'button-secondary', label: '审计日志', to: 'B27' },
      ]},
      { id: 'invite', label: '邀请管理员', blocks: [
        sideRole,
        { kind: 'topbar', label: '系统管理 / 管理员 / 邀请', sub: '角色：超级管理员' },
        { kind: 'page-header', label: '邀请管理员' },
        { kind: 'form-row', label: '姓名', sub: '必填' },
        { kind: 'form-row', label: '邮箱 / 用户名', sub: '登录账号，唯一' },
        { kind: 'form-row', label: '初始密码', sub: '首次登录强制修改（可选 TOTP）' },
        { kind: 'form-row', label: '角色', sub: '○ 内容运营  ○ 健康运营  ○ CRM  ○ 客服  ○ 财务  ○ 审计只读' },
        { kind: 'alert', tone: 'warn', label: '创建与停用均写审计日志', sub: '停用后该账号会话立即失效', marker: 1 },
        { kind: 'button-primary', label: '创建账号（二次确认）' },
        { kind: 'button-secondary', label: '返回管理员列表' },
      ]},
    ],
    annotations: {
      goal: '用「模块 + 数据范围 + 操作类型」三层模型管理后台账号能看什么、能做什么；并维护管理员账号生命周期。',
      entry: '侧边栏-系统管理-角色权限 / 管理员（web：/system/roles、/system/admins）',
      exit: ['B27'],
      role: '超级管理员（唯一可管理角色与成员）',
      data: [
        '角色矩阵（8 个预置角色） — §2',
        '权限树：模块 × 9 种操作类型 — §2 三层模型',
        '成员与数据范围 — 管理员表（对齐 web /system/admins）',
      ],
      actions: {
        primary: '编辑角色权限（二次确认后即时生效）',
        secondary: ['新建/复制角色', '邀请/停用管理员', '查看成员列表'],
        destructive: '停用管理员：二次确认；停用即踢出会话并写审计',
      },
      statesDesc: ['角色列表', '权限树编辑', '管理员账号', '邀请管理员', '保存成功', '无权限（非超管不可见）'],
      triggers: [
        '权限变更 → 即时生效 + 写审计日志（§5.11）',
        '「敏感数据查看」为独立开关，控制 B18/B19 的脱敏解锁',
        '停用管理员 → 踢出会话 + 审计',
      ],
      deps: ['全部后台模块（权限生效面）', 'B27 审计日志（变更留痕）', 'B01 登录（角色渲染菜单）', 'cleancircle_web /system/admins'],
      patches: ['对齐 web 管理员页 2026-08-11'],
    },
  },
];
