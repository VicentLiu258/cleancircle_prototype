...
export const screensUser: ScreenDef[] = [
  {
    ...
    states: [
      { id: 'default', label: '默认列表', blocks: [
        ...
        { kind: 'page-header', label: '用户列表 · 24,860', sub: '筛选：ID/用户名/昵称/手机、注册/活跃时间、会员状态、训练状态、周期阶段、标签、渠道、版本（后端§2.2）' },
        { kind: 'filter-bar', label: '搜索 ID/昵称/手机 ｜ 会员：全部 ｜ 标签：全部 ｜ 渠道：全部 ｜ 版本：全部 ｜ 活跃：7 日内', marker: 1 },
        { kind: 'alert', tone: 'info', label: '批量操作（已选 3 人）', sub: '添加标签 · 移除标签 · 加入分群 · 批量发送消息 → B28 · 导出筛选结果', marker: 2, patch: true },
        { kind: 'table', cols: ['☐', '用户', '手机号', '来源', '订阅状态', '标签', '周期', '打卡', '操作'], items: [
          '☑ ｜ U-10231 ｜ 138****6688 ｜ 新注册 ｜ 体验第 5 天 ｜ 新手 ｜ 卵泡期 ｜ 4 天 ｜ 详情',
          '☑ ｜ U-08771 ｜ 139****2210 ｜ 迁移 ｜ 订阅中·月卡 ｜ 大基数,减脂 ｜ 黄体期 ｜ 21 天 ｜ 详情',
          '☑ ｜ U-07890 ｜ 137****9012 ｜ 迁移 ｜ 已失效 ｜ 流失风险 ｜ 经期 ｜ 0 ｜ 详情',
          '☐ ｜ U-06554 ｜ 136****3345 ｜ 新注册 ｜ 未评测 ｜ — ｜ — ｜ 0 ｜ 详情',
        ], to: 'B19', marker: 3 },
        { kind: 'button-secondary', label: '批量添加标签', to: 'B17' },
        { kind: 'button-secondary', label: '批量发送消息', to: 'B28' },
    ...
    annotations: {
      ...
      statesDesc: ['默认（含批量条）', '客服脱敏视图', '筛选无结果', '加载中', '加载失败', '无权限'],
      triggers: [
        '迁移状态=部分成功的行 → 详情页置顶迁移待处理提示（联动 B20 失败重试）',
        '手机号完整值查看 → 敏感数据查看权限 + 二次确认 + 写审计（§5.11）',
        '批量添加标签/分群 → B17；批量消息 → B28',
      ],
      deps: ['移动端 S26 我的（订阅/能量值状态同源）', 'B17 标签分群', 'B20 迁移任务结果', 'B27 审计日志', 'B28 触达'],
      patches: ['H-08', '后端§2.2 批量操作'],
    },
  },
  {
